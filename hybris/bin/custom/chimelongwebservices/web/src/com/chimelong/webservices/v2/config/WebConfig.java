 ...
 */
package com.chimelong.webservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.chimelong.webservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "chimelongwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "chimelongwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "chimelongwebservices.oauth2.tokenUrl";

	private static final String DESC = "chimelongwebservices.v2.description";
	private static final String TITLE = "chimelongwebservices.v2.title";
	private static final String VERSION = "chimelongwebservices.v2.version";
